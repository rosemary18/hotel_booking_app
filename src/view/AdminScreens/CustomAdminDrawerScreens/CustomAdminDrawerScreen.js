...
export class CustomAdminDrawerScreen extends Component {
  render() {
    return (
      <View style={{flex: 1}}>
        <View
        ...
        <TouchableOpacity onPress={() => alert('Redirect to users soon ..')}>
          <View style={styles.ButtonNav}>
            <Icon name="perm-identity" color="#889aa4" />
            <Text style={{marginLeft: 10, color: '#889aa4'}}>Users</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => alert('Redirect to rooms soon ..')}>
          <View style={styles.ButtonNav}>
            <Icon name="library-add" color="#889aa4" />
            <Text style={{marginLeft: 10, color: '#889aa4'}}>Rooms</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => alert('Redirect to Booking soon ..')}>
          <View style={styles.ButtonNav}>
            <Icon name="inbox" color="#889aa4" />
            <Text style={{marginLeft: 10, color: '#889aa4'}}>
              Room Reservations
            </Text>
          </View>
        </TouchableOpacity>
...
CustomAdminDrawerScreen.propTypes = {
